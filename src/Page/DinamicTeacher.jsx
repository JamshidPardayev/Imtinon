...
const DynamicTeacher = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        setTeacher(response.data.teacher); // Assuming the API returns an object with teacher info
      } catch (error) {
  ...
  return (
    <div className="py-4 px-8">
      ...
      <div className="flex flex-wrap gap-x-[50px] mt-4 border py-4 px-2 border-gray-300 my-1 items-start">
        <div className="text-center">
          <img src="./image/download.png" alt="No Data" className="max-w-[300px] mx-auto" />
