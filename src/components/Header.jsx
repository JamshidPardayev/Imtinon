  ...
  return (
    <div className='sticky top-0 left-0 part2 min-h-[95px] py-2 bg-[#FCFAFA] flex flex-wrap items-center gap-x-[15px] gap-y-3 justify-between w-full max-sm:overflow-x-hidden'>
      <FaArrowRightArrowLeft 
        ...
        className='text-[20px] text-[#333333] ml-[30px] hover:text-blue-600 cursor-pointer duration-300' 
      />
      <div className='flex items-center flex-wrap gap-y-3'>
        ...
        <button 
          onClick={Logout} 
          className='flex items-center justify-center gap-x-2 w-[120px] h-[40px] bg-[#509CDB] rounded-[8px] text-[14px] text-white font-semibold mr-[35px] hover:bg-blue-800 duration-300 max-md:mr-3 max-sm:w-[50px] max-sm:ml-[30px]'
        >
